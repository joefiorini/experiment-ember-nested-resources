...
window.startApp          = require('testing-ember-nested-resources/tests/helpers/start_app')['default'];
window.isolatedContainer = require('testing-ember-nested-resources/tests/helpers/isolated_container')['default'];
